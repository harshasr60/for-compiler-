lenovoharsha@DESKTOP-VRAMNOQ:~$ ssh bgautam@ala-salim-lx1
bgautam@ala-salim-lx1's password:
...
Last login: Tue Jun  2 22:44:39 2026 from 128.224.23.243
/folk/bgautam
bgautam@ala-salim-lx1:/folk/bgautam$ cd /ala-salim-lx12/bgautam/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam$ cd harsha1/
-bash: cd: harsha1/: No such file or directory
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam$ cd harsha
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha$ cd../
...
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha$ cd ..
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam$ ls
harsha     license.htm  setup.ini    setup_linux32  vxworks_auto_r1_linux_20260309060009326.zip
installer  readme.txt   setup_linux  vxworks_auto   yum.repos
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam$ cd harsha
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha$ ./vxworks-7-25.09/install/wrenv.sh
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha$ cd vxworks-7-25.09/install/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ ls
3pp-download  download   install.properties  main         readme-tools_wb_tcl  vip_vxsim  workbench-4
compilers     etc        legal-notices       maintenance  setup                vsb_vxsim  wrenv.linux
cyclonedx     hello.cpp  license             readme       setup.log            vxworks    wrenv.sh
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ vi hello.cpp
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
[wr-c++]   /cc-conf/default.conf
[wr-c++]
[wr-c++] To solve this, set the following environment variable:
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp -static
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
[wr-c++]   /cc-conf/default.conf
[wr-c++]
[wr-c++] To solve this, set the following environment variable:
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd..
cd..: command not found
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
...
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd ..
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09$ wr-c++ -o main hello.cpp
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
[wr-c++]   /cc-conf/default.conf
[wr-c++]
[wr-c++] To solve this, set the following environment variable:
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09$ wr-c++ -o main hello.cpp -static
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
[wr-c++]   /cc-conf/default.conf
[wr-c++]
[wr-c++] To solve this, set the following environment variable:
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09$ cd install/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
[wr-c++]   /cc-conf/default.conf
...
[wr-c++] To solve this, set the following environment variable:
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ echo $WIND_CC_SYSROOT

bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ pwd
...
env | grep WIND
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install
3pp-download  download   install.properties  main         readme-tools_wb_tcl  vip_vxsim  workbench-4
compilers     etc        legal-notices       maintenance  setup                vsb_vxsim  wrenv.linux
cyclonedx     hello.cpp  license             readme       setup.log            vxworks    wrenv.sh
ls: cannot access 'install': No such file or directory
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/host/x86_64-linux/bin/wr-c++
WIND_USR=
WIND_BUILD=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build
WIND_WELCOME_URL=https://docs.windriver.com/category/os_vxworks_25.09
WIND_PLATFORM=vxworks-7
WIND_HOST_TYPE_WB=x86_64-linux2
WIND_VSB_PROFILE_PATHS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build/misc/vsb_profiles
WIND_VX7_HOST_TYPE=x86_64-linux
WIND_FOUNDATION_PATH=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/host
WIND_PKGS_DIR_NAME=os
WIND_LLVM_HOST_TYPE=LINUX64
WIND_PREBUILT_PATHS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/samples/prebuilt_projects
WIND_HOST=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/host
WIND_WRWB_PATH=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/eclipse/x86_64-linux2
WIND_DOCS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/generated_documents/docs
WIND_3PP_PROVIDED_PATH=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/3pp-download
WIND_PKGS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/os
WIND_UTILITIES=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/host/x86-linux2/bin
WIND_COMPILER_PATHS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers
WIND_WRVX_MK=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build/mk/wrvx
WIND_BASE=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09
WIND_PREFERRED_PACKAGES=vxworks/25.09
WIND_SOURCE_BASE=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source
WIND_VX7_LLVM_HOST_TYPE=LINUX64
WIND_SAMPLES=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/samples/system:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/samples/rtp:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/samples/dkm:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/samples/wrtool/wrlinux:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/samples/wrtool/vxworks7:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/samples/wrtool:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/samples/windiss:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/samples/vxworks7
WIND_RPM=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/eclipse
WIND_HOME=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install
WIND_USR_MK=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build/mk/usr
WIND_SPIN_ID=0
WIND_RUST_HOST_TYPE=x86_64-unknown-linux-gnu
WIND_BUILD_TOOL=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build/tool
WIND_TOOLCHAINS=rust:llvm
WIND_SHARED_SOURCE_BASE=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/shared-source
WIND_RUST_PATH=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/rust-1.85.0.0
...
WIND_KRNL_MK=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build/mk/krnl
WIND_COMPONENTS_LIBNAMES=
WIND_LLVM_PATH=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1
WIND_WB_HOSTTOOLS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/25.09/x86_64-linux2
WIND_VX7_RUST_HOST_TYPE=x86_64-unknown-linux-gnu
WIND_HOST_TYPE=x86-linux2
WIND_RELEASE_ID=25.09
WIND_WRSV_PATH=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4/wrsysviewer
WIND_TOOLS=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/workbench-4
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09

source install/wrenv.sh
bash: /bin/wrenv.linux: No such file or directory
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha$ cd vxworks-7-25.09/install/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd vxworks-7-25.09/install/
-bash: cd: vxworks-7-25.09/install/: No such file or directory
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ vi hello.cpp
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp
wr-c++: command not found
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$  which clang
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ ls
3pp-download  download   install.properties  main         readme-tools_wb_tcl  vip_vxsim  workbench-4
compilers     etc        legal-notices       maintenance  setup                vsb_vxsim  wrenv.linux
cyclonedx     hello.cpp  license             readme       setup.log            vxworks    wrenv.sh
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ ./wrenv.sh
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++
[wr-c++] Error: cannot find config file (tried ...)
[wr-c++]   /cc-conf/default
[wr-c++]   /cc-conf/default.conf
[wr-c++]
[wr-c++] To solve this, set the following environment variable:
[wr-c++] WIND_CC_SYSROOT=path/to/VSB
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd vsb_vxsim/usr/rust/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ ls
rustc.bat  rustc.linux  rustdoc.bat  rustdoc.linux  rustenv.bat  rustenv.linux  rust-run.bat  rust-run.linux
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ vi rustenv.linux
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ . ./rustenv.linux
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ wr-c++
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ ls
rustc.bat  rustc.linux  rustdoc.bat  rustdoc.linux  rustenv.bat  rustenv.linux  rust-run.bat  rust-run.linux
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ wr-c++ --help
...
OPTIONS:
  ...
  -fcomplex-ppc-gnu-abi   Pass Complex values in GPR instead of stack for PowerPC-32
  ...
  -ffixed-date-time=<value>
                          Set __DATE__, __TIME__, __TIMESTAMP__ to a fixed value, a UNIX timestamp, defined as the number of seconds, excluding leap seconds, since 01 Jan 1970 00:00:00 UTC
  ...
  -mldstex                Allow generation of ldrex/strex atomic instructions.
  ...
  -mno-ldm-stm            Disallow generation of ldm/stm/ldrd/strd instructions (ARM only).
  -mno-ldstex             Disallow generation of ldrex/strex atomic instructions.
  ...
  -mno-va-float           do not generate FP save code in variadic functions
  ...
  -mva-float              generate FP save code in variadic functions (default)
...
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr/rust$ cd ../
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/usr$ cd ../
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim$ which clang
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/clang
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim$ cd vsb_vxsim/usr/rust/
bash: cd: vsb_vxsim/usr/rust/: No such file or directory
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim$ ls
3pp            config.json             Makefile     tcl                     vsb.cmdDefault  vsbl
buildDefaults  creation_arguments.log  mk           usr                     vsb.config      vsblCdf
cc-conf        dkm                     scgdefs.tcl  vsb.AllAvailableLayers  vsb.config.old  vsblh
cleanList.mk   h                       share        vsb_bs.vxconfig         vsb_defs.mk     vsb.vxconfig
config         krnl                    tcInfo       vsb_build.log           vsbdefs.tcl     vsb_vxsim.wpj
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim$ vi hello.cpp
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim$ cd ..
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ vi hello.cpp
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp
hello.cpp:7:13: error: expected ';' after return statement
    7 |     return 0
      |             ^
      |             ;
1 error generated.
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ vi hello.cpp
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cp main ./vip_vxsim/romfs
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd vip_vxsim/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim$ make
./content.romfs build done
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/clang  --target=x86_64 -m64 -mcmodel=large   -mno-red-zone -fno-builtin -nostdlib -fno-omit-frame-pointer -mno-implicit-float -std=c11 -D__vxworks -D__VXWORKS__ -D__ELF__ -D_HAVE_TOOL_XTORS  -nostdlibinc -nostdinc++ -ftls-model=local-exec -fno-builtin -fno-strict-aliasing  -ffp-model=precise -D_USE_INIT_ARRAY -fwrapv -mllvm -two-entry-phi-node-folding-threshold=2 -fno-unwind-tables -fno-asynchronous-unwind-tables -fdebug-default-version=4 -g  -nostdlib -fno-builtin -I. -I./vxsim_linux_2_0_1_2      -I.  -I/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/configlette  -DCPU=_VX_SIMLINUX -DTOOL_FAMILY=llvm -DTOOL=llvm -D_WRS_KERNEL  -DINET -DINET6 -DINET6    -xassembler-with-cpp -D_WRS_VX_SMP    -D_WRS_VX_SMP '-D_VSB_CONFIG_FILE="/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/h/config/vsbConfig.h"'   -isystem/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/h/public -isystem/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/h/system -I/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/share/h -D_VSB_PUBLIC_HDR_DIR=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/h/public -I/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/3pp/develop/usr/include  -DCPU=_VX_SIMLINUX -DTOOL_FAMILY=llvm -DTOOL=llvm -DPRJ_BUILD -D_WRS_KERNEL -DINET -DINET6 -DINET6    -MD -c -o romfs_image_prj.o romfs_image_prj.s
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/clang  --target=x86_64 -m64 -mcmodel=large   -mno-red-zone -fno-builtin -nostdlib -fno-omit-frame-pointer -mno-implicit-float -std=c11 -D__vxworks -D__VXWORKS__ -D__ELF__ -D_HAVE_TOOL_XTORS  -nostdlibinc -nostdinc++ -ftls-model=local-exec -fno-builtin -fno-strict-aliasing  -ffp-model=precise -D_USE_INIT_ARRAY -fwrapv -mllvm -two-entry-phi-node-folding-threshold=2 -fno-unwind-tables -fno-asynchronous-unwind-tables -fdebug-default-version=4 -g  -nostdlib -fno-builtin -Wall -Wconversion -Wno-sign-conversion -Wno-unused-but-set-variable -Wno-deprecated-non-prototype  -I. -I./vxsim_linux_2_0_1_2      -I.  -I/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/configlette  -DCPU=_VX_SIMLINUX -DTOOL_FAMILY=llvm -DTOOL=llvm -D_WRS_KERNEL  -DINET -DINET6 -DINET6   -D_WRS_VX_SMP    -D_WRS_VX_SMP '-D_VSB_CONFIG_FILE="/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/h/config/vsbConfig.h"'   -isystem/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/h/public -isystem/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/h/system -I/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/share/h -D_VSB_PUBLIC_HDR_DIR=/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/h/public -I/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/3pp/develop/usr/include  -DCPU=_VX_SIMLINUX -DTOOL_FAMILY=llvm -DTOOL=llvm -DPRJ_BUILD -D_WRS_KERNEL -DINET -DINET6 -DINET6     -MD -D_WRS_VX_SMP    -D_WRS_VX_SMP -c  /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/configlette/version.c
touch versionTag
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/clang -D_IMAGE_RAM -D_NORMAL -Dsimlinux -E -P -I /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim - < /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vxworks/25.09/source/build/tool/gnu_binutils_2018_07/krnl/ldscript.krnl.template -o   /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim/vip.ld
/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/ldpentium -m elf_x86_64 -X -N   --eh-frame-hdr  --no-warn-execstack --no-warn-rwx-segments   -e _vxStart --defsym ENTRY_SYMBOL=_sysInit   \
     --defsym _VX_VMA_START=0x180010000 --defsym _VX_LMA_START=0x0 romfs_image_prj.o @./prjObjs.lst \
        @./subprjObjs.lst @./childrenObjs.lst  \
        version.o usrEntry.o --start-group \
        -L/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/llvm_ -L/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/llvm -L./krnl/lib -L/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/SIMLINUX/common -L/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vsb_vxsim/krnl/3pp/develop/usr/lib    -lcplus -lBRIDGE -lCOREIP -lDHCPC -lDHCPC6 -lDHCPR -lDHCPS6 -lDNSC -lFTP -lIPCOM -lIPNET -lIPTCP -lL2TP -lNTP -lPPP -lRADIUS -lSCEP -lSECCRYPTO -lSEC_HASH -lSNTP -lTFTP -lVXCOREIP -laim -lapps -larch -lbdmXbd -lboard -lc -lcommon -lcommoncc -lcoredump -lcoreio -lcoremm -lcoreutil -lcplusplus -lcrc -lcrypto -ldefault -ldiameter -ledr -lend -lerfLib -levdevLib -lfdt -lfsCommon -lfsDevfs -lfsDosfs -lfsHrfs -lfsNfs -lfsRomfs -lfsVfs -lfsVrfs -lfsapiUtil -lhwdb -lip_crypto -ljobqueue -lkasanTest -llegacy -lllvm -lllvmcplus -lloader -lloopFs -lmbedtls_hash -lmib2 -lmulticore -lnet_base -lobj -lostools -loverlay -lpthread -lpxUserGroup -lpxmem -lpxrt -lpxsig -lpxtrace -lrandom -lrbuff -lrpc -lrpmsg -lrpmsgDrv -lrtp -lruntime_analysis -lruntime_analysis_cachedemo -lruntime_analysis_hpc -lruntime_analysis_intlatencydemo -lruntime_analysis_iodemo -lruntime_analysis_memdemo -lruntime_analysis_topdemo -lruntime_analysis_usereventdemo -lservices -lshell -lsmpdemo -lsocket -lssl -lstacktrace -lstopmode -lsysctl -ltcfagent -ltcfsvservice -ltls -ltpm -lumask -lutf -luuid -lvdfs -lvxbus -lvxsim -lwind -lwindinh -lwindq -lwindview -lzlib -lrqdef -lspl -ltcfagentvx  --end-group  ctdt.o symTbl.o\
         -defsym _VX_DATA_ALIGN=1  -T /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim/vip.ld  -o vxWorks
true  vxWorks
VX_CPU_FAMILY=pentium vxsize -p /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/sizepentium -v 0xffffffffffffffff 0x180010000 vxWorks
vxWorks: 6801104(t) + 610616(d) + 498816(b) = 7910536 (18446744067259123712 bytes left)
VX_CPU_FAMILY=pentium image-tag -tag vxWorks;
flags = 0x2
true
rm versionTag
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim$ vxsim -p 3
Checking License...OK
...
Physical Top  Address: 0x0000000190000000    Physical Size: 0x0000000010000000 (256Mb)
Loading...
0x713168 + 0x79cd8
...
Volume Parameters: FAT type: FAT32, sectors per cluster 0
  ...
  Root dir entries 0, sysId (null)  , serial number 70000
  Label:"           " ...
Disk with 32768 sectors of 512 bytes will be formatted with:
Volume Parameters: FAT type: FAT16, sectors per cluster 2
  2 FAT copies, 16303 clusters, 64 sectors per FAT
  Sectors reserved 1, hidden 0, FAT sectors 128
  Root dir entries 512, sysId VXDOS16 , serial number 70000
  Label:"           " ...
OK.
   ...
   \........\      /......../
    \........\    /......../
     \........\   \......./
      \........\   \...../              VxWorks SMP 64-bit
       \........\   \.../
        \........\   \./     Release version: 25.09
         \........\   -      Build date: Jun  3 2026 01:59:09
          \........\
            ...
            \...../   -                 1984-2026
             \.../   /.\
              \./   /...\
               ...
               CPU Count: 2
          OS Memory Size: 252MB
        ED&R Policy Mode: Deployed
     Debug Agent: Started (always)
         Stop Mode Agent: Started (always)

Wed Jun  3 02:00:14 2026: ipcom_drv_eth[1029900]: Error: ipcom_drv_eth_bind_to_devs :: failed to get name of boot device
Wed Jun  3 02:00:14 2026: ipnet[1029900]: Error: No interface name specified for 'ifname' and 'devname' was not found

 Adding 10332 symbols for standalone.
...
[vxWorks *]# Goodbye.
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim$ cd ..
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ wr-c++ -o main hello.cpp -static
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cp main ./vip_vxsim/romfs
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install$ cd vip_vxsim/
bgautam@ala-salim-lx1:/ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/vip_vxsim$ make
...
true  vxWorks
VX_CPU_FAMILY=pentium vxsize -p /ala-salim-lx12/bgautam/harsha/vxworks-7-25.09/install/compilers/llvm-18.1.8.1/LINUX64/bin/sizepentium -v 0xffffffffffffffff 0x180010000 vxWorks
vxWorks: 9260304(t) + 610616(d) + 498816(b) = 10369736 (18446744067256666112 bytes left)
VX_CPU_FAMILY=pentium image-tag -tag vxWorks;
flags = 0x2
true
rm versionTag
    ...
    \........\    /......../
     \........\   \......./
      \........\   \...../              VxWorks SMP 64-bit
       \........\   \.../
        \........\   \./     Release version: 25.09
         \........\   -      Build date: Jun  3 2026 02:07:38
          \........\
           \......./         Copyright Wind River Systems, Inc.
            \...../   -                 1984-2026
             \.../   /.\
...
Wed Jun  3 02:07:49 2026: ipcom_drv_eth[1029900]: Error: ipcom_drv_eth_bind_to_devs :: failed to get name of boot device
Wed Jun  3 02:07:49 2026: ipnet[1029900]: Error: No interface name specified for 'ifname' and 'devname' was not found
...
Wed Jun  3 02:08:39 2026: ipcom_drv_eth[1029900]: Error: ipcom_drv_eth_bind_to_devs :: failed to get name of boot device
Wed Jun  3 02:08:39 2026: ipnet[1029900]: Error: No interface name specified for 'ifname' and 'devname' was not found
